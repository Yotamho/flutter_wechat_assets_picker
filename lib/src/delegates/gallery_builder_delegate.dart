...
class GalleryBuilderDelegate extends DefaultAssetPickerBuilderDelegate {
  GalleryBuilderDelegate({required super.provider, required super.initialPermission, super.locale, this.customGridItemWidgetBuilder, this.viewerBottomDetailWidgetBuilder});
